...
class Contact(db.Model):
    ...
    status     = db.Column(db.String(30), default="Lead")        # pipeline stage
    lead_source = db.Column(db.String(30), default="Other")
    lead_type  = db.Column(db.String(20), default="Buyer")       # Buyer or Seller
    property_interests = db.Column(db.Text)                       # notes / what they want
    last_contact_at = db.Column(db.DateTime)                      # last time she reached out
